...
import { getLangFromStorage } from '../lib/i18n' // ここは ../lib にしてあります

// デフォルトのタスク（クエリでタスクが来なかったとき用）
const DEFAULT_TASKS = [
  {
...
export default function RecordPage() {
  ...
  // /record?task=... という古い形式にも対応
  const taskFromQueryLegacy = searchParams.get('task') || ''
  // /record?childId=... の場合はその子に紐付ける
