...
import { LS_SONGS, LS_CHILDREN, LS_ROLE, LS_MODE, LS_CURRENT_CHILD_ID, LS_TASKS, LS_HISTORY, ROUTE_HISTORY_EDIT } from "../constants";
import {
...
export function useHistoryPageLogic() {
  ...
  function handleEditClick(absoluteIndex) {
    ...
    window.location.href = `${ROUTE_HISTORY_EDIT}?id=${absoluteIndex}`;
  }
