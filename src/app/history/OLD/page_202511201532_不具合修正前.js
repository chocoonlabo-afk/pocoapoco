...
export default function HistoryPage() {
  ...
  const decoratedList = filteredRecords
    .map((r, originalIndex) => ({ originalIndex, record: r }))
    .reverse();

  // グラフ用データ
  const chartData = buildChartData(filteredRecords, periodType);
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "11px", color: "#777", marginBottom: "8px" }}>
          上のタスクと期間をえらぶと、合計練習時間のグラフが見られます。
        </p>
