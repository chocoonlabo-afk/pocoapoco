...
export default function HistoryPage() {
  ...
  useEffect(() => {
    ...
    if (detectedRole === "child") {
      // 子モードなら「自分」。"all" は無効として扱い、保存がなければ最初の子
      if (
  ...
  // ※ 履歴画面では currentChildId を localStorage に保存しない
  //   → 設定画面/ホーム側の「この子を表示」を上書きしないため
